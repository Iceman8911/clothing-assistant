...
export const gClothingItemStore = {
   ...
   */
	...
	addItem(
		...
		/** Set the timestamps */
		const date = uploadToServer ? new Date() : clothing.dateEdited;
		clothing.dateEdited = date;
		this.lastEdited = date;
		this.storeLastEdited[gEnumReactiveMember.SETTER](date);
